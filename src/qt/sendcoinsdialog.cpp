    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Geld address (e.g. HPHWwxzA9gfTKR4CU1Dfgp5W8C8QSviVk8)"));
#endif
...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    case WalletModel::DescriptionTooLong:
        QMessageBox::warning(this, tr("Send Coins"),
            tr("Error: Description is too long."),
            QMessageBox::Ok, QMessageBox::Ok);
        break;
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
        ...
        else if (!CBitcoinAddress(text.toStdString()).IsValid())
        {
            ...
            ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid Geld address"));
        }
        else
        {
